...
def complement_permmatrix(order):
    ...
    np.array
        Permutation matrix
    """
    perm = numpy.zeros((pow(NNUC, order), pow(NNUC, order)))
...
class Complement(Layer):
    ...
    def call(self, inputs):  # pylint: disable=arguments-differ
        return tf.einsum('ij,bsj->bsi', self.rcmatrix, inputs)
...
class Minput(Layer):
    def __init__(self, output_dim, **kwargs):
        ...
        super(Minput, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        self.kernel = self.add_weight(name='kernel',
                                      ...
                                      initializer='uniform',
                                      trainable=True)
        super(Minput, self).build(input_shape)
...
class Selection(Layer):
    ...
    def build(self, input_shape):
        super(Selection, self).build(input_shape)
